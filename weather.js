...
GLoc = {
    ...
    geoError: function (error) {
        let geoErrorMessageTimeoutId = setTimeout(GLoc.showGeoErrorMessageBanner, 5000);
        switch (error.code) {
        case error.TIMEOUT:
...
WeatherInfo = {
    ...
    changeTempUnit: function(unit) {
        let newTemp = w.tempNumber - 273.15;
        if (unit === 'fahrenheit') {
...
CanvasBackground = {
    ...
    chooseBackground: function(condition) {
        ...
        switch (condition) {
          case 'Thunderstorm':
            ...
            cololet = c.iconColor.thunderstorm;
    ...
    getRandomBackground: function() {
        ...
        let possibleAnimations = [CanvasBackground.animateSnow, CanvasBackground.animateRain, CanvasBackground.animateClouds];
        let randomAnimation = Math.round(Math.random() * (possibleAnimations.length - 1));
    ...
    animateRain: function(condition) {
        ...
        // Create a Data URI.
        let rainSrc = 'data:image/svg+xml;base64,'+window.btoa(rainSvg);
         
        // Load up our image.
        let rainSource = new Image();
    ...
    animateClouds: function() {
        ...
        // Create a Data URI.
        let cloudSrc = 'data:image/svg+xml;base64,'+window.btoa(cloudSvg);
         
        // Load up our image.
        let cloudSource = new Image();
    ...
    animateTime: function() {
        ...
        // Create a Data URI.
        let timeSrc = 'data:image/svg+xml;base64,'+window.btoa(timeSvg);
         
        // Load up our image.
        let timeSource = new Image();
    ...
    animateLightning: function() {
        ...
        // Create a Data URI.
        let lightningSrc = 'data:image/svg+xml;base64,'+window.btoa(lightningSVG);
         
        // Load up our image.
        let lightningIMG = new Image();
        ...
        function thunderDraw(){
            ...
            function flash() {
                ...
                let locx = Math.random() * (c.lightningCanvas.width - 165);
                let locy = Math.random() * (c.lightningCanvas.height- 478);
